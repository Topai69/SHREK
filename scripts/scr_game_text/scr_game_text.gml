...
function scr_game_text(_text_id)
{
	switch(_text_id)
	{
		...
		scr_text("Yeah, that’s what I thought until I fell into this stupid hole!");
			...
			scr_option("Did you injure yourself when you fell?", "npc 2 - what");
		...
		scr_text("And now look at me! Stuck in this hole, worse than before!");
			scr_option("I’m so sorry… I made the same mistake, I don’t want to be there!", "npc 2 - me too");
			scr_option("This isn’t fair! I didn’t ask for any of this!", "npc 2 - cry");
		...
		scr_text("I feel like I’ve done something wrong. Ugh, why am I sharing this with a stranger.");
			scr_option("Sometimes it helps to talk. So what happened?", "npc 3 - ask");
		...
		scr_text("Let’s go. I’ll help you find the way.");
		...
		scr_text("You’re probably right. But it’s so hard. ");
